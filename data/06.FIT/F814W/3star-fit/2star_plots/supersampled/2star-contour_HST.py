...
#g.plot_2d(samples2,'X2_CENTER','Y2_CENTER', filled=False, colors=['k'], lims=[chains1['X1_CENTER'][1000]-1001, chains1['X1_CENTER'][1000]+1001,chains1['Y1_CENTER'][1000]-1001,chains1['Y1_CENTER'][1000]+1001])
